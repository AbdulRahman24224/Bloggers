...
@Inject constructor(
    ...
    suspend fun getAuthorPostsFromServer(authorId: Int, page: Int ) = service.getAuthorPosts(authorId,page)

    suspend fun getAuthorPostsFromDatabase(authorId: Int, page: Int ) = database.authorsDao.retrieveAuthorPostsByPage(authorId ,page)
